  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Button variant='solid' style={styles.button}>
          Solid Button
        </Button>
        <Button variant='bordered' style={styles.button}>
          Bordered Button
        </Button>
        ...
        <Button variant='faded' style={styles.button}>
          Faded Button
        </Button>
      ...
      <View style={styles.section}>
        ...
        <Button size='sm' style={styles.button}>
          Small Button
        </Button>
        <Button size='md' style={styles.button}>
          Medium Button
        </Button>
      ...
      <View style={styles.section}>
        ...
        <Button radius='none' style={styles.button}>
          No Radius
        </Button>
        <Button radius='sm' style={styles.button}>
          Small Radius
        </Button>
        <Button radius='md' style={styles.button}>
          Medium Radius
        </Button>
        <Button radius='lg' style={styles.button}>
          Large Radius
        </Button>
        <Button radius='full' style={styles.button}>
          Full Radius
        </Button>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Button isDisabled style={styles.button}>
          Disabled Button
        </Button>
